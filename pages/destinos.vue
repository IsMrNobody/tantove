        ...
        <v-row align="center" class="min-height-40vh">
          <v-col cols="12" md="8">
            ...
            <p class="text-h6 mb-6">
              Explora la diversidad geográfica de Venezuela, desde playas paradisíacas 
              hasta montañas andinas y selvas amazónicas.
            </p>
            <v-btn size="large" color="accent" class="text-primary font-weight-bold tricolor-hover">
      ...
      <v-container class="container-custom">
        <v-row>
          <v-col
            ...
            class="mb-8"
          >
            <v-card class="destination-card h-100 hover-lift tricolor-border" elevation="4">
              ...
              <v-card-text class="pa-4">
                <h3 class="text-h6 font-weight-bold mb-2">{{ destination.name }}</h3>
    ...
    <v-dialog v-model="destinationModal" max-width="800">
      <v-card v-if="selectedDestination">
        ...
        <v-card-text class="pa-6">
          ...
          <p class="text-body-1 mb-6">{{ selectedDestination.fullDescription }}</p>
          ...
          <v-list density="compact">
            <v-list-item>
              ...
              <v-list-item-title>Mejor época: {{ selectedDestination.bestTime }}</v-list-item-title>
            </v-list-item>
            <v-list-item>
              <template v-slot:prepend>
                <v-icon color="primary">mdi-car</v-icon>
              </template>
              <v-list-item-title>Cómo llegar: {{ selectedDestination.howToGet }}</v-list-item-title>
            </v-list-item>
            <v-list-item>
              <template v-slot:prepend>
                <v-icon color="primary">mdi-home</v-icon>
              </template>
              <v-list-item-title>Alojamiento: {{ selectedDestination.accommodation }}</v-list-item-title>
            </v-list-item>
          </v-list>
        </v-card-text>
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Descubre los mejores destinos turísticos de Venezuela. Desde playas paradisíacas hasta montañas andinas.' }
  ]
})
...
const regions = [
  'Caribe', 'Andes', 'Canaima', 'Llanos', 'Guayana', 'Centro', 'Oriente'
]

const destinationTypes = [
  'Playa', 'Montaña', 'Ciudad', 'Selva', 'Histórico', 'Natural'
]

const activities = [
  'Senderismo', 'Buceo', 'Fotografía', 'Cultura', 'Aventura', 'Relajación'
]
...
const destinations = [
  {
    ...
    type: 'Playa',
    typeColor: 'blue',
    description: 'Archipiélago paradisíaco con aguas cristalinas y arenas blancas.',
    fullDescription: 'Los Roques es un parque nacional marino ubicado en el Mar Caribe, a 176 km al norte de Caracas. Está formado por más de 350 islas, cayos e islotes que forman una laguna de aguas cristalinas de incomparable belleza.',
    rating: 5,
  ...
  },
  {
    ...
    fullDescription: 'El Salto Ángel es la cascada más alta del mundo, ubicada en el Parque Nacional Canaima. Sus aguas caen desde la cima del tepuy Auyantepuy, creando un espectáculo natural único en el planeta.',
    rating: 5,
  ...
  },
  {
    ...
    fullDescription: 'Mérida, conocida como la "Ciudad de los Caballeros", es una ciudad universitaria ubicada en los Andes venezolanos. Es famosa por su teleférico, el más alto y largo del mundo, que lleva a los visitantes hasta el Pico Espejo.',
    rating: 4.8,
  ...
  },
  {
    ...
    fullDescription: 'Isla Margarita es conocida como la "Perla del Caribe" por sus hermosas playas, clima tropical y rica historia. Ofrece una combinación perfecta de relajación, aventura y entretenimiento.',
    rating: 4.7,
    image: 'https://images.pexels.com/photos/1586673/pexels-photo-1586673.jpeg',
  ...
  },
  {
    ...
    fullDescription: 'El Delta del Orinoco es una vasta región de humedales donde el río Orinoco se divide en cientos de canales antes de desembocar en el Atlántico. Es hogar de la etnia Warao y una biodiversidad única.',
    rating: 4.6,
    image: 'https://images.pexels.com/photos/417173/pexels-photo-417173.jpeg',
  ...
  },
  {
    ...
    fullDescription: 'Caracas es la capital de Venezuela, una metrópolis moderna ubicada en un valle de la Cordillera de la Costa. Ofrece una rica vida cultural, excelente gastronomía y importantes sitios históricos.',
    rating: 4.2,
...
const filteredDestinations = computed(() => {
  ...
  if (selectedActivity.value) {
    filtered = filtered.filter(d => d.activities.includes(selectedActivity.value))
  }
